...
const affiliateProducts = [
    {
        "id": 9089,
        "title": "Insane: New: Discbound Heirloom Journal Bundle (Tan Leather - Standard 6\" x 8.5\") $179.00",
        "category": "Other",
        "source": "Ugmonk",
        "price": "$179.00",
        "originalPrice": "---",
    ...
    {
        "id": 6153,
        "title": "Savage: Select Accounts: 20-Pack 0.92-Oz Jack Link's Beef Sticks (Original) $9.60 w/ S&S",
        "category": "Other",
    ...
    {
        "id": 4528,
        "title": "Insane: 15.5-Oz Amazon Grocery Canned Garbanzo Beans 4 for $2.70 w/ S&S",
    ...
    {
        "id": 5856,
        "title": "Must-Have: Select Amazon Accts: 5-Lbs. Fernes Hydrolyzed Collagen Peptides Protein Powder $27.60 w/ S&S + Free S&H",
        "category": "Food & Grocery",
        "source": "Slickdeals",
        "price": "$27.60",
        "originalPrice": "---",
    ...
    {
        "id": 5093,
        "title": "Premium: 4-Pk IPYNBAP Outdoor Patio Cushions (Blue, 19\"x19\"x3\") $23 + Free S&H",
    ...
    {
        "id": 2976,
        "title": "Savage: Ring Wired Retinal 4K Doorbell Pro Security Camera (3rd Gen, Deep Silver) from $130 & More + Free S&H",
        "category": "Tech",
        "source": "Slickdeals",
        "price": "$130",
        "originalPrice": "---",
        "image": "https://media.base44.com/images/public/6a477d0a1f5ba6a40fc0b08e/634adaf28_generated_image.png",
        "link": "https://www.amazon.com/dp/B0F151GFYR?tag=bigterry20036-20",
        "badge": "HOT"
    },
    {
        "id": 8701,
    ...
    {
        "id": 7549,
        "title": "Premium: Prime Members: 15.5-oz Amazon Grocery Canned Pinto Beans 4 for $2.80 + Free S&H w/ S&S",
        "category": "Food & Grocery",
        "source": "Slickdeals Food",
        "price": "$2.80",
        "originalPrice": "---",
    ...
    {
        "id": 9017,
        "title": "Brutal: 110-Lb OLILAWN Foldable Heavy Duty Patio Umbrella Base Stand $50 + Free S&H",
        "category": "Home & Kitchen",
        "source": "Slickdeals",
        "price": "$50",
        "originalPrice": "---",
        "image": "https://media.base44.com/images/public/6a477d0a1f5ba6a40fc0b08e/db76a2f0d_generated_image.png",
        "link": "https://www.amazon.com/dp/B0HH8MBC99?tag=bigterry20036-20",
        "badge": "NEW"
    },
    {
        "id": 4029,
        "title": "Premium: 10-pc TILUCK Measuring Cups & Spoons Set (various) $5.50 ",
        "category": "Other",
        "source": "Slickdeals Food",
        "price": "$5.50",
        "originalPrice": "---",
    ...
    {
        "id": 1635,
        "title": "Unbeatable: 8.85-Oz. RITZ Fresh Stacks (6 Multi Snack Packs) 2 for $6 ",
        "category": "Food & Grocery",
        "source": "Slickdeals",
        "price": "$6",
        "originalPrice": "---",
    ...
    {
        "id": 8548,
        "title": "Viral: New: Discbound Journal Bundle (Standard 6\"x 8.5\" Journal) $99.00",
        "category": "Other",
        "source": "Ugmonk",
        "price": "$99.00",
        "originalPrice": "---",
    ...
    {
        "id": 3838,
        "title": "Insane: Carhartt Men's Iconic J01 Duck Detroit Jacket (Black, S - XL) $89.75 + Free S&H",
        "category": "Fashion",
        "source": "FatWallet",
        "price": "$89.75",
        "originalPrice": "---",
    ...
    {
        "id": 7965,
        "title": "Epic: New: Analog - Today Cards $13.00",
        "category": "Other",
        "source": "Ugmonk",
        "price": "$13.00",
        "originalPrice": "---",
    ...
    {
        "id": 8792,
        "title": "Elite: 15-Pk VOLLYC Travel Vacuum Bags w/ Rechargeable Air Pump $12 ",
        "category": "Home & Kitchen",
        "source": "Slickdeals",
        "price": "$12",
        "originalPrice": "---",
    ...
    {
        "id": 5668,
        "title": "Exclusive: 12\" x 8\" Fibogollo Bamboo End Grain Butcher Block Cutting Board $8 ",
        "category": "Other",
        "source": "Slickdeals Food",
        "price": "$8",
        "originalPrice": "---",
